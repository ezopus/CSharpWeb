...
namespace SeminarHub.Migrations
{
    ...
    [Migration("20241014195920_SeminarModelBoolDeleteAdded")]
    partial class SeminarModelBoolDeleteAdded
    {
            ...
            modelBuilder.Entity("SeminarHub.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Unique identifier for each category.");
            ...
            modelBuilder.Entity("SeminarHub.Data.Models.Seminar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Unique identifier of seminar");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"), 1L, 1);

                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasComment("The category identifier for each seminar.");

                    b.Property<DateTime>("DateAndTime")
                        .HasColumnType("datetime2")
                        .HasComment("The start date and hour of the seminar.");

                    b.Property<string>("Details")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasComment("Details for each seminar.");

                    b.Property<int>("Duration")
                        .HasColumnType("int")
                        .HasComment("The duration of each seminar in minutes.");
                    ...
                    b.Property<string>("Lecturer")
                        ...
                        .HasComment("Lecturer name giving the seminar.");

                    b.Property<string>("OrganizerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Unique identifier of each organizer.");

                    b.Property<string>("Topic")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("Name of the seminar topic.");
