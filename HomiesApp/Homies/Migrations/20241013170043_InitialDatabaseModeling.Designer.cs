...
namespace Homies.Migrations
{
    ...
    [Migration("20241013170043_InitialDatabaseModeling")]
    partial class InitialDatabaseModeling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Homies.Data.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("The primary identifier of an event.");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<DateTime>("CreatedOn")
                        .HasColumnType("datetime2")
                        .HasComment("The time on which the event was created.");

                    b.Property<string>("Description")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)")
                        .HasComment("The description of each event up to symbol limit.");

                    b.Property<DateTime>("End")
                        .HasColumnType("datetime2")
                        .HasComment("The planned time at which the event will end.");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("The name of each event.");

                    b.Property<string>("OrganiserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("The unique id of each organiser of current event.");

                    b.Property<DateTime>("Start")
                        .HasColumnType("datetime2")
                        .HasComment("The time at which the event begins.");

                    b.Property<int>("TypeId")
                        .HasColumnType("int")
                        .HasComment("The unique id of each type of event");
